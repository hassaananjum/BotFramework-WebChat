        ...
        return (
            <div className={ className }>
                ...
                <button
                    ...
                    type="button"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="20" height="20" viewBox="0 0 20 20" data-tags="send">
                        <g fill="#444" transform="scale(0.01953125 0.01953125)">
                            <path d="M0 0l1024 512-1024 512v-1024zM0 409.6v204.8l512-102.4-512-102.4z"/>
                        </g>
                    </svg>
                </button>
                <button
